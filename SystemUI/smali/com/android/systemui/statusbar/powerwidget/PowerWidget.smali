...
.method private recreateButtonLayout()V
    ...
    iget-object v6, p0, Lcom/android/systemui/statusbar/powerwidget/PowerWidget;->mButtonLayout:Landroid/widget/LinearLayout;

    invoke-virtual {v6}, Landroid/widget/LinearLayout;->getPaddingTop()I

    move-result v6

    iget-object v7, p0, Lcom/android/systemui/statusbar/powerwidget/PowerWidget;->mButtonLayout:Landroid/widget/LinearLayout;

    invoke-virtual {v7}, Landroid/widget/LinearLayout;->getPaddingRight()I

    move-result v7

    iget-object v8, p0, Lcom/android/systemui/statusbar/powerwidget/PowerWidget;->mScrollView:Landroid/widget/HorizontalScrollView;

    invoke-virtual {v8}, Landroid/widget/HorizontalScrollView;->getVerticalScrollbarWidth()I
